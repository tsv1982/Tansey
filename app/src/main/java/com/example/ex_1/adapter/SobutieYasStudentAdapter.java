...
import java.util.List;
    ...
    public class SobutieYasStudentAdapter extends ArrayAdapter<StudentСardEntity> {

        private LayoutInflater inflater;
        private int layout;
        private List<StudentСardEntity> studentEntityList;

        public SobutieYasStudentAdapter(Context context, int resource, List<StudentСardEntity> StudentEntityList) {
        ...
        public View getView(int position, final View convertView, ViewGroup parent) {
            ...
            TextView nameStudent = view.findViewById(R.id.TV_Name_student_Sobutiy);
            TextView groupStudent = view.findViewById(R.id.TV_Group_student_Sobutiy);
